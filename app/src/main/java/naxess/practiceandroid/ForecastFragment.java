    ...
    public class FetchWeatherTask extends AsyncTask<String,Void,String[]>
    {
        ...
        protected String[] doInBackground(String... params)
        {
            ...
            try
            {
                ...
                //URL url = new URL("http://api.openweathermap.org/data/2.5/forecast/daily?q=11788&mode=json&units=metric&cnt=7id=524901&APPID=fbdb1bd9a21f79aa5ab46b5739ee96fc");
                /* Alternative URL format to the above line
                String baseUrl = "http://api.openweathermap.org/data/2.5/forecast/daily?q=11788&mode=json&units=metric&cnt=7";
